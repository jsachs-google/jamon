...
public class JamonCodeScanner extends RuleBasedScanner {
     ...
     */
    public JamonCodeScanner(JamonColorProvider provider) {
        ...
        rules.add(wordRule);
        rules.add(new JamonTagMatchingRule("java", new Token(new TextAttribute(provider.getColor(JamonColorProvider.JAMON_KEYWORD)))));
